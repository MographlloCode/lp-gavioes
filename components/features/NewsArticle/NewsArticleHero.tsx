...
export function NewsArticleHero({ hero }: NewsArticleHeroProps) {
  return (
    <figure className="overflow-hidden rounded-sm border border-zinc-200 bg-zinc-50">
      ...
      <figcaption className="flex flex-col gap-2 border-t border-zinc-200 px-4 py-3 text-xs leading-relaxed text-zinc-600 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
